...
export default function CartQuantityButton({ productId, productName, price, imageUrl }: Props) {
  ...
  return (
    <button
      ...
      className="bg-hot hover:bg-hot-dark text-white font-semibold py-2 px-3 rounded-full text-sm transition-colors flex items-center justify-center gap-1.5 w-full"
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
