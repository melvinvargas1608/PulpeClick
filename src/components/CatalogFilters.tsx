      ...
      <div className="flex flex-1 min-w-0 items-stretch">
        <div className="relative flex-1 min-w-0">
          ...
          <input
            ...
            placeholder="Buscar..."
            className="w-full h-10 pl-8 pr-3 py-2 border border-gray-300 border-l-0 rounded-none text-sm focus:ring-2 focus:ring-brand focus:border-brand outline-none"
